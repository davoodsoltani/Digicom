...
import com.hads.digikala.data.model.category.Sub
import com.hads.digikala.R
import com.hads.digikala.data.remote.NetworkResult
import com.hads.digikala.ui.components.LoadingView
...
fun SubCategorySection(
    ...
    val subCategoryResult by viewModel.category.collectAsState()
