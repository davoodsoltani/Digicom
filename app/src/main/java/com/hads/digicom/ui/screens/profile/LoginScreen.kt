...
import com.hads.digicom.utils.InputValidation.isValidEmail
    ...
    LazyColumn(
        ...
        item {
            Image(
                modifier = Modifier
                    .size(200.dp),
                painter = painterResource(id = R.drawable.digi_red),
                contentDescription = "",
            )
        }
        item { Spacer(modifier = Modifier.height(MaterialTheme.spacing.large)) }
        ...
        item {
            MyButton(text = stringResource(id = R.string.digicom_entry)) {
